...
<table class="marge">
  ...
  <option value="XH">Xhosa</option>
      ...
      <tr>
      	<td><input type="radio" name="motif" value="etude"> Études</td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
      	<td><input type="radio" name="motif" value="etude" checked> Études</td>
      </tr>
      <tr>
        <td>
        	<input type="radio" name="motif" value="autre"> Autres
      ...
      <tr>
        ...
        <td> <input type="checkbox" name="besoin_hebergement" value="oui" checked> Hébergement provisoire</td>
        <?php } else { ?>
        <td> <input type="checkbox" name="besoin_hebergement" value="oui"> Hébergement provisoire</td>
        <?php } ?>
      </tr>
      <tr>
      	<?php if($etudiant['besoin_accompagnement']=='oui'){ ?>
      	<td><input type="checkbox" name="besoin_accompagnement" value="oui" checked> Accompagnement</td>
      	<?php } else { ?>
      	<td><input type="checkbox" name="besoin_accompagnement" value="oui"> Accompagnement</td>
      	<?php } ?>
      </tr>
	  <tr>
	  	<?php if($etudiant['besoin_transport']=='oui'){ ?>
        <td><input type="checkbox" name="besoin_transport" value="oui" checked> Recherche de moyens de transport</td>
        <?php } else { ?>
        <td><input type="checkbox" name="besoin_transport" value="oui"> Recherche de moyens de transport</td>
        <?php } ?>
      </tr>
      <tr>
