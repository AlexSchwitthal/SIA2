			...
			<form name="form" method="post" action="index.php?uc=gestionAdherent&action=validerModificationAdherent" onsubmit="return confirm('Validez les modifications ?');">
				<div class="formDiv">
					<table style="width: 100%">
						...
						<tr>
							<td>Adresse : </td>
							<td><input type="text" id="adresse" name="adresse" value="<?php echo $lAdherent['adresse'] ?>" size="35"></td>
						</tr>

						<tr>
							<td>Ville : </td>
							<td ><input type="text" id="ville" name="ville" value="<?php echo $lAdherent['ville'] ?>" size="30"> </td>
						</tr>

						<tr>
							<td>Code postal : </td>
							<td><input type="text" id="cp" name="cp" onkeypress="validate(event)" maxlength="5" value="<?php echo $lAdherent['cp'] ?>" size="5"></td>
						</tr>
						...
						<tr>
							<td> Mail : </td>
							<td><input type="text" id="email" name="email" value="<?php echo $lAdherent['email'] ?>" width="25"> </td>
						</tr>
