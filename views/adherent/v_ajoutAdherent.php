...
<div class="col-md-10">
  ...
  <form name="form" method="post" action="index.php?uc=gestionAdherent&action=validerAdherent">
    <table class="marge">
      ...
      <tr>
        <td> Adresse : </td>
        <td colspan="2"><input type="text" id="adresse" name="adresse" style="width:100%"></td>
      </tr>
      ...
      <tr>
        <td> Ville : </td>
        <td colspan="2"><input type="text" id="ville" name="ville" style="width:100%"> </td>
      </tr>
      ...
      <tr>
        <td> Code postal : </td>
        <td colspan="2"><input type="text" id="cp" name="cp" onkeypress="validate(event)" maxlength="5" style="width:100%"></td>
      </tr>
      ...
      <tr>
        <td> Mail : </td>
        <td colspan="2"><input type="text" id="email" name="email" style="width:100%"> </td>
      </tr>
      ...
      <tr>
        <td> Mot de passe : </td>
        <td colspan="2"><input type="password" id="mdp" name="mdp" style="width:100%"> </td>
      </tr>

      <tr>
        <td> Confirmer votre mot de passe : </td>
        <td colspan="2"><input type="password" id="mdpconfirm" name="mdpconfirm" style="width:100%"> </td>
      </tr>
    </table>
    <br>
    ...
    <p><input type="checkbox" id="cgv" name="cgv"><em>Vous autorisez l’association EPA à stocker les informations vous concernant.</em></p>
    <input type="submit">
  </form>
</div>
