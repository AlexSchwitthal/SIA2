			...
			<form name="form" method="post" action="index.php?uc=gestionAdherent&action=validerAdherent" onsubmit="return confirm('êtes vous sûr de vos informations ?');">
				<div class="formDiv">
					<table style="width: 100%">
						...
						<tr>
							<td> Adresse : </td>
							<td><input type="text" id="adresse" name="adresse" size="35"></td>
						</tr>

						<tr>
							<td> Ville : </td>
							<td><input type="text" id="ville" name="ville" size="30"> </td>
						</tr>

						<tr>
							<td> Code postal : </td>
							<td><input type="text" id="cp" name="cp" onkeypress="validate(event)" maxlength="5" size="5"></td>
						</tr>
						...
						<tr>
							...
							<input type="tel" id="tel" name="tel"></td>
						</tr>
